...
public class DashboardService {
    ...
    public List<DashboardCard> getDashBoardCards() {
       ...
       public List<DynamicCard> getDynamicCard() {
        return Arrays.asList(new DynamicCard("2", "Mawala The Board game", "https://starfish-app-trwgh.ondigitalocean.app/Ticket/Mawala - The Board Game.jpg", "Explaination of the board game and various modes to play it", "video",true, true),
                new DynamicCard("1", "Shiv Shatak - Chronicles of ShivChhatrapati Maharaj", "https://starfish-app-trwgh.ondigitalocean.app/Ticket/100 Stories.jpg", "Brief historical context of 100 events from ShivChhatrapati's life", "audio", true, false),
                ...
                new DynamicCard("4", "Mawala - The Pandora", "https://starfish-app-trwgh.ondigitalocean.app/Ticket/War Stories.jpg", "Aspects of legends from the field about various topics of Shiv Era!", "video", true, true),
                ...
                new DynamicCard("7", "स्वराज्याची भूषणे", "https://starfish-app-trwgh.ondigitalocean.app/Ticket/स्वराज्याची भूषणे.jpg", "Information about forts of Sahyadry", "video", true, true),
